...
def main():
    ...
    while True > 0:
        ...
        axs[0][0].scatter(xp, yp, s=100.0, marker=carrot, color = 'g', alpha = 0.5)
        axs[0][0].set_xticklabels([])
        axs[0][0].set_yticklabels([])       
